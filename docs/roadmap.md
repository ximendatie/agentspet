...
| 2 | 0.2.x | 让工程基础可扩展 | Provider 注册表、拆分 UI 组件、fixture 测试、状态置信度。 |
| 3 | 0.3.x | 让它成为日常工具 | 首次启动引导、通知、菜单栏模式、Prompt Queue。 |
...
| `FutureTasksView` | Future Task / Prompt Queue 界面 |
...
| P1 | Prompt Queue | 将未来任务变成可执行的工作流入口。 |
